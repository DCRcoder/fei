...
var (
	...
	ModelNotSupportType                    = errors.New("model only support model{} or &model{}")
	RecordNotFound                         = errors.New("record not found")
	UpdateRowMustWithConditionAndTableName = errors.New("update row method must have condition and table Name")
	UpdateRowParamMustHaveValue            = errors.New("update row method param must have value")
	ModelMustHavePrimaryKey                = errors.New("model must have primary key")
)
